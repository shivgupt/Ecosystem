...
2. Send dOrg payment for the first period (Oct 1 - Oct 31). [See progress report here](https://github.com/dOrgTech/Ecosystem/blob/master/DAOstack/Genesis_Milestone_01.md).
